...
Before diving into your spread, gather these essentials. The right tools make the process smoother and more enjoyable. But what exactly should you have on hand? Let's break it down by category.

### Essential Supplies for a Vintage Junk Journal Spread

- **A blank junk journal or notebook** with mixed-media paper (at least 140 lb/300 gsm weight to handle wet media). Look for a journal with a sewn binding, as it lies flat for easier layering. If you're using a pre-made journal, test a small area with water to ensure the paper doesn't buckle.
- **Printable vintage ephemera**—see the sources section below for the best collections. Always print on high-quality paper for best results. For a truly authentic feel, use a laser printer (toner resists water better than inkjet ink if you plan to tea-dye).
- **Scissors or a paper trimmer** with a decorative edge (like pinking shears) for added vintage flair. A craft knife with a self-healing mat is great for intricate cuts. For curves, use small embroidery scissors.
- **Adhesive**: a glue stick for paper-on-paper, double-sided tape for flat elements, and foam dots for dimension. For heavy layers, use a gel medium like Mod Podge. Avoid liquid school glue, which can warp thin paper.
- **Distress ink or tea-dye** for aging (optional but highly recommended for authenticity). Walnut stain and vintage photo are popular shades. You can also use a blending tool with foam applicator for even coverage.
- **Embellishments**: lace trim, washi tape, tiny brads, fabric scraps, or dried flowers. Consider using vintage buttons or keys for extra texture. A small amount of gold or copper leaf can add a subtle shimmer.
- **A bone folder** to crease folds and smooth layers without tearing. A stylus can also work for scoring. Use it to press down edges for a crisp finish.
- **A spray bottle with water**: for lightly dampening paper to create wrinkles or soften edges. Add a drop of brown ink to the water for a tinted effect.

### Pro Tip: Paper Selection

Choose paper that mimics vintage textures—cream cardstock, kraft paper, or handmade cotton paper. Avoid bright white, which looks modern. If you only have white paper, tone it down with a light wash of coffee or tea before printing. For a more authentic feel, use aged book pages or sheet music as a base layer. Want to know a secret? Old dictionary pages work wonders because the text is dense and the paper is thin, allowing for easy layering.

## Step 1: Choose a Cohesive Color Palette

Why does a color palette matter? Vintage spreads work best with muted, earthy tones. Think sepia, dusty rose, olive green, and cream. Pick two or three colors from your printable collection and stick to them. This creates visual harmony. For example, if your ephemera features faded blue stamps and sepia photos, use those as your anchor colors.

### How to Test Your Palette

Print a small swatch of each element you plan to use. Lay them out side by side. Do they feel connected? If one piece looks too bright or out of place, swap it for something softer. A good rule: 70% of your spread should be in your main palette, 20% in a secondary color, and 10% as an accent (like a pop of deep red or gold). Use a color wheel to find complementary shades—muted greens pair well with warm browns, for instance. You can also use a digital tool like Adobe Color to extract a palette from a favorite vintage image.

### Practical Example: Building a Palette from a Single Image

Let's say you have a vintage botanical print with faded pink roses and sage green leaves. From that, pull: cream (background), dusty rose (main), sage green (secondary), and a touch of charcoal (accent for text or borders). Now, every piece of ephemera you add should fall within this range. If you have a bright yellow ticket stub, tone it down with a wash of tea before including it.
...
### Building a Focal Point Hierarchy

- **Primary focal point** (largest): occupies about 30% of the page. Example: a full-size botanical print or a vintage advertisement. This should be the most detailed or visually striking element.
- **Secondary elements** (medium): 2–3 pieces that complement the focal point, like a ledger page or a postcard. These should be about 15-20% of the page each. They add context and support the main image.
- **Tertiary details** (smallest): tiny stamps, labels, or text snippets that add texture without overwhelming. Use these sparingly to avoid clutter. A single tiny keyhole image or a small butterfly can be enough.

### How to Arrange Your Focal Points

Lay out all pieces on your spread before gluing. Move them around until the composition feels balanced. Use the rule of thirds: imagine a 3x3 grid over your page, and place focal points at the intersections. For a two-page spread, treat each page as its own grid, but ensure visual flow from left to right. For example, if the primary focal point is on the left page, let a secondary element on the right page echo its color or shape.
