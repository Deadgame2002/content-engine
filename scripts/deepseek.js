...
- СТРУКТУРА ЗАГОЛОВКОВ (важно для SEO и читаемости):
  - Минимум 4-5 секций с подзаголовками ## (H2), каждая раскрывает конкретный аспект темы, не общие слова
  - Хотя бы в 2-3 секциях добавь подзаголовки ### (H3) внутри — например конкретные примеры, шаги, под-варианты. Не делай все секции "плоскими", вложенная структура (H2 → H3) делает статью визуально интереснее и помогает Google понимать иерархию темы
